...
export const cardStyles = 'rounded-lg border bg-white p-6 shadow-sm hover:shadow-md transition-shadow duration-200';

export const headerStyles = 'flex items-start justify-between gap-4';

export const titleContainerStyles = 'flex flex-col flex-grow';

export const titleStyles = 'text-lg font-semibold text-gray-900 line-clamp-2';

export const descriptionStyles = 'mt-2 text-sm text-gray-500 line-clamp-3';
...
export const tagContainerStyles = 'mt-4 flex flex-wrap gap-2';
