        ...
        <div className="fixed inset-y-0 left-0 w-56 bg-white border-r border-gray-200">
          ...
          <nav className="mt-4">
            <div className="space-y-2 px-2">
              <a
                href="/admin"
                className="flex items-center rounded-md px-3 py-2 text-sm font-medium text-gray-900 bg-gray-50 hover:bg-gray-100"
              >
                <svg className="mr-2.5 h-5 w-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
